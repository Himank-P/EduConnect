    ...
    <footer className="main-footer">
      <div className="container">
        <div className="footer-grid">
          ...
          {/* Quick Links Column - NOW DYNAMIC */}
          <div className="footer-column">
            ...
            <ul className="footer-links">
              ...
              {user?.role === 'teacher' && (
                <>
                  <li><Link to="/teacher/my-classes">My Classes</Link></li>
                  <li><Link to="/teacher/homeroom">Homeroom</Link></li>
                </>
              )}

              {user?.role === 'school' && (
                <>
                  <li><Link to="/admin/students">Student Records</Link></li>
                  <li><Link to="/admin/finances">Finances</Link></li>
                  <li><Link to="/admin/transport">Transport</Link></li>
                </>
              )}
              {/* --- END OF ROLE-BASED LINKS --- */}
